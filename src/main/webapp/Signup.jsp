    ...
    <div class="card-body">
      <form action="signup" method="post">
        <div class="form-group">
          ...
          <input type="text" name="full-name" class="form-control" placeholder="Enter Full Name">
        </div>
        <div class="form-group">
          <label>Email address</label>
          <input type="email" name="signup-email" class="form-control" placeholder="Enter email">
        </div>
        <div class="form-group">
